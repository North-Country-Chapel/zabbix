...
Monitors weekday podcast publishing schedule.
...
def calculate_metrics() -> Dict[str, Any]:
    ...
    if published:
        ...
        # Check if today's episode was published
    ...
    # Filter to posts that are actually in the future
    weekday_scheduled = [
...
def main():
    parser = argparse.ArgumentParser(description='Podcast WordPress Monitoring for Zabbix')
